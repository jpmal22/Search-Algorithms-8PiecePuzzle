...
//  8-PUZZLE PROBLEM
//  
//  Start-up codes by N.H.reyes PHD Massey University
//
//  Name(s):
//  Date:
//
...
int main( int argc, char* argv[] ){
   ...
   string path;
    ...
    } // this if statement is how we get the initial state and goal state takes the 4th and 5th command line arg.
    // only works for single run as batch runs will have < 3 argc
